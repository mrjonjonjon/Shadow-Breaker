...
<tileset version="1.5" tiledversion="1.7.2" name="Ancient Ruins-wall-7" tilewidth="32" tileheight="32" tilecount="70" columns="10">
 <image source="../Tilesets/wall-7 - 2 tiles tall.png" width="320" height="224"/>
 <wangsets>
  <wangset name="wall7" type="corner" tile="-1">
