...
<tileset version="1.5" tiledversion="1.7.2" name="Ancient Ruins-wall-4" tilewidth="32" tileheight="32" tilecount="128" columns="16">
 <image source="../Tilesets/wall-4 - 3 tiles tall.png" width="512" height="256"/>
 <wangsets>
