...
<tileset version="1.5" tiledversion="1.7.2" name="Ancient Ruins-Animated Terrains2-8 frames-with transparency" tilewidth="32" tileheight="32" tilecount="522" columns="29">
 <image source="../Tilesets/Tileset-Animated Terrains2-8 frames-with transparency.png" width="928" height="576"/>
 <tile id="29">
  <animation>
 ...
 <wangsets>
  <wangset name="platform(grass) to blood" type="corner" tile="-1">
