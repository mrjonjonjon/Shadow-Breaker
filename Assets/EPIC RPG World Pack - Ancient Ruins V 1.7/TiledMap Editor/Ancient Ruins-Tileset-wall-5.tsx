...
<tileset version="1.5" tiledversion="1.7.2" name="Ancient Ruins-wall-5" tilewidth="32" tileheight="32" tilecount="98" columns="10">
 <image source="../Tilesets/wall-5 - 2 tiles tall.png" width="320" height="224"/>
 <wangsets>
  <wangset name="wall5" type="corner" tile="-1">
